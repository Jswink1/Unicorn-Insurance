...
{
    public class CreateMobileSuitCartItemHandler : IRequestHandler<CreateMobileSuitCartItemCommand, BaseCommandResponse>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public CreateMobileSuitCartItemHandler(IUnitOfWork unitOfWork,
                                           IMapper mapper,
        ...
        public async Task<BaseCommandResponse> Handle(CreateMobileSuitCartItemCommand request, CancellationToken cancellationToken)
        {
