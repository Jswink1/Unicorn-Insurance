...
{
    public class CreateWeaponCartHandler : IRequestHandler<CreateWeaponCartCommand, BaseCommandResponse>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public CreateWeaponCartHandler(IUnitOfWork unitOfWork,
                                       IMapper mapper,
        ...
        public async Task<BaseCommandResponse> Handle(CreateWeaponCartCommand request, CancellationToken cancellationToken)
        {
