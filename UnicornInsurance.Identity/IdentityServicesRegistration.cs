...
using UnicornInsurance.Identity.Services;
...
namespace UnicornInsurance.Identity
{
    public static class IdentityServicesRegistration
    {
        public static IServiceCollection ConfigureIdentityServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDbContext<UnicornIdentityDBContext>(options =>
                options.UseSqlServer(configuration.GetConnectionString("UnicornIdentityDB"),
                b => b.MigrationsAssembly(typeof(UnicornIdentityDBContext).Assembly.FullName)));
